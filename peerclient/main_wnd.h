...
class MainWindow {
 public:
  ...
  virtual void StartLocalRenderer(TitanTrackInterface* local_video) = 0;
  virtual void StopLocalRenderer() = 0;
  virtual void StartRemoteRenderer(TitanTrackInterface* remote_video) = 0;
...
class MainWnd : public MainWindow {
 public:
  ...
  virtual void StartLocalRenderer(TitanTrackInterface* local_video);
  virtual void StopLocalRenderer();
  virtual void StartRemoteRenderer(TitanTrackInterface* remote_video);
  ...
  class VideoRenderer : public rtc::VideoSinkInterface<webrtc::VideoFrame> {
   public:
    VideoRenderer(HWND wnd, int width, int height,
                  TitanTrackInterface* track_to_render);
   ...
   protected:
    ...
    rtc::scoped_refptr<TitanTrackInterface> rendered_track_;
  };
